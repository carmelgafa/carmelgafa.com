...
- **quniform()** - Specifies a continuous hyperparameter space as a uniform distribution with a minimum and maximum.
- **qnormal()** - Specifies a continuous hyperparameter space as a normal distribution with a mean and standard deviation.
...
- **RandomParameterSampling**. Random sampling supports discrete and continuous hyperparameters
- **GridParameterSampling**. Grid sampling supports discrete hyperparameters, however it is possible to create a discrete set from a distribution of hyperparameters.
